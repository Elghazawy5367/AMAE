...
**AMAE uses this in:** guardrail.prompt.md, content-mirror.prompt.md 
 
--- 
 
## PATTERN 5: Output Format Contract 
 
**What it does:** States exact output format with examples before generation 
**Rule:** Always include "Output ONLY [type]. No preamble." as final line 
 
**AMAE uses this in:** all prompts that need structured output (JSON or labeled sections) 
``` 
