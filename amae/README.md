...
**What does AMAE actually produce?** 
Every week: LinkedIn post, Twitter thread, Reddit post draft, Quora answer draft, newsletter 
draft, and an AEO blog article. All grounded in real audience language mined from Reddit 
that week. 
 
**What does it cost?** 
Phase 1 (text only): $0/month. OpenRouter free tier covers all AI calls. Full media production 
with images + video: ~$52–71/month. 
 
**Do I need to know how to code?** 
No. Fill in one JSON config file, add one API key, and trigger one workflow. Everything else 
is automated. 
 
**What if content doesn't sound like me?** 
The `brand_voice` section of `product-dna.json` controls this. Add real phrases you use. Add 
words you never say. Be specific. 
 
**How do I know if it's working?** 
Real resonance signals: comments saying "this is exactly my situation", DMs asking for 
access, unprompted shares, replies with someone's own version of the frustration. Likes with 
no comments = not working yet. 
 
--- 
*AMAE v1 — March 2026 · Node 20 · ESM · OpenRouter free tier · GitHub Actions* 
``` 
